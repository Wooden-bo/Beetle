# Generated by Django 2.0.7 on 2018-08-13 13:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=0, unique=True, verbose_name='轮播顺序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_desc', ckeditor_uploader.fields.RichTextUploadingField(verbose_name='商品描述')),
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.Brand', verbose_name='商品品牌')),
            ],
            options={
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_tab', models.BooleanField(default=False, help_text='是否为导航', verbose_name='是否为导航')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=0, unique=True, verbose_name='排序')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
            ],
            options={
