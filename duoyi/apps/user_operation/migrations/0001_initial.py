    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(default='留言', max_length=100, verbose_name='主题')),
                ('message', ckeditor_uploader.fields.RichTextUploadingField(default='', help_text='留言内容', verbose_name='留言内容')),
